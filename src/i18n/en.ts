export default {
  ...
  auth: {
    ...
    forgotPasswordSubtitle: 'Enter your phone number to receive verification code',
    sendResetCode: 'Send Reset Code',
    enterResetCode: 'Enter Reset Code',
    enterResetCodeSubtitle: 'We sent a verification code to your phone',
    verifyResetCode: 'Verify Code',
    createNewPassword: 'Create New Password',
    createNewPasswordSubtitle: 'Your new password must be different from previous password',
  ...
  posts: {
    ...
    reportModalTitle: 'Report Post',
    reportReason: 'What\'s wrong with this post?',
    reportReasonHelper: 'Your report is anonymous, except if you\'re reporting an intellectual property infringement.',
    reportSubmit: 'Submit Report',
    reportSuccess: 'Report Submitted',
    reportSuccessMessage: 'Thank you for your report. We\'ll review this content and take appropriate action if necessary.',
    ...
    reportReasons: {
      ...
      gore: 'Gore or Blood',
      goreDescription: 'Graphic images of blood, gore, or disturbing medical content',
      blood: 'Blood Content',
      bloodDescription: 'Images containing blood or bloody scenes',
      graphicViolence: 'Graphic Violence',
      graphicViolenceDescription: 'Extremely violent or disturbing content that may be traumatic',
    },
    ...
    cameraOnly: 'Camera only - new photos',
    caption: 'Caption',
    ...
    postExpiryNotice: 'Important Notice',
    postExpiryMessage: 'This post will automatically disappear after 24 hours from posting. Are you sure you want to post?',
  ...
  notifications: {
    ...
    postRemovedForViolence: 'Your post has been removed for violent content',
    postRemovedForGore: 'Your post has been removed for graphic content',
